...
//escapes special characters in a string
 ...
 $query = "INSERT into `worker` (name, phone, salary, address, joined) VALUES ('$p2', '$p3', '$p4', '$p5', '$p6')";
        ...
        <div class="row">
          <div class="col-lg-4 main-chart">
            ...
            <div class="custom-bar-chart">
               <form name="insertworker" action="" method="post">
                 <div class="login-wrap">
				
					<input type="text" name="p2"  class="form-control" placeholder="WORKER NAME" required> 
					<br>
					<input type="text" name="p3" maxlength="10" class="form-control" placeholder="WORKER PHONE" required> 
					<br>
					<input type="TEXT" name="p4"  class="form-control" placeholder="WORKER SALARY" required> 
					<br>
					<input type="TEXT" name="p5"  class="form-control" placeholder="WORKER ADDRESS" required> 
					<br>
					<input type="date" name="p6"  class="form-control" placeholder="JOINED DATE" required> 
					<br>
