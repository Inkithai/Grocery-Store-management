...
//escapes special characters in a string
 ...
 $query = "INSERT into `dealer` (name, phone, address, no_items) VALUES ('$p2', '$p3', '$p4', '$p5')";
            ...
            <div class="custom-bar-chart">
               <form name="index" action="" method="post">
                 <div class="login-wrap">
					...
					<input type="text" name="p2"  class="form-control" placeholder="DEALER NAME" required> 
					<br>
					<input type="number" maxlength="10"  name="p3"  class="form-control" placeholder="DEALER PHONE" required> 
					<br>
					<input type="TEXT" name="p4"  class="form-control" placeholder="DEALER ADDRESS" required> 
					<br>
					<input type="TEXT" name="p5"  class="form-control" placeholder="NUMBER OF ITEMS" required> 
					<br>
