...
{ ?>
							...
							<form action="dsend.php" method="post">
                        
                        <td><input type="text" value="<?php echo $data['id']; ?>" readonly name="p1"> </td>						
                     ...
                     <td><button class="au-btn au-btn-icon au-btn--green au-btn--small" type="submit">DELETE</button></td>
											</form>
                                            </tr>
