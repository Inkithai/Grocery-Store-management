...
//escapes special characters in a string
 ...
 $query = "INSERT into `orders` (gid, qnt, tprice, cid) VALUES ('$p2', '$p3', '$p4', '$p5')";
        ...
        <div class="row">
          <div class="col-lg-4 main-chart">
            ...
            <div class="custom-bar-chart">
               <form name="order.php" action="" method="post">
                 <div class="login-wrap">
				
					<input type="text" name="p2"  class="form-control" placeholder="GROCERY ID" required> 
					<br>
					
					<select name="p3" class="form-control"required >
					<option value="NULL" > Purchased Quantity</option>
					...
					<br>
					<input type="number" name="p4"  class="form-control" placeholder="Total  PRICE" required> 
					<br>
					<input type="number" name="p5"  class="form-control" placeholder="CUSTOMER ID" required> 
					<br>
