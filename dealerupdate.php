...
<body>
  ...
  error_reporting(0);
    ...
    $query="SELECT * from dealer where id='".$_GET['id']."'";
        ...
        <div class="row">
          <div class="col-lg-4 main-chart">
            ...
            <div class="custom-bar-chart">
               <form  action="dealerupdate1.php" method="post">
                 <div class="login-wrap">
					...
					<br>
					<input type="TEXT" name="p4" value="<?php echo $data['address']; ?>"  class="form-control" placeholder="DEALER ADDRESS"> 
					<br>
					<input type="TEXT" name="p5" value="<?php echo $data['no_items']; ?>" class="form-control" placeholder="NUMBER OF ITEMS"> 
					<br>
