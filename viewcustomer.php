...
{ ?>
						...
						<td> <a href="customerupdate.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are You Sure')">UPDATE    
				</a> 
				</td>
						<td> <a href="customerdelete.php?id=<?php echo $data['id'];?>" onclick="return confirm('Are You Sure')">DELETE    
				</a> 
				</td>
