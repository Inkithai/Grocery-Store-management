...
//escapes special characters in a string
 ...
 $query = "INSERT into `customer` (name, phone, amount, item, address) VALUES ('$p2', '$p3', '$p4', '$p5', '$p6')";
        $result = mysqli_query($con,$query);

        if($result){
			header("Location: index.php");
            echo "<div class='form'><h3>customer updated successfully.</h3></div>";
            ...
            <div class="custom-bar-chart">
               <form name="index" action="" method="post">
                 <div class="login-wrap">
					...
					<input type="text" name="p2"  class="form-control" placeholder="CUSTOMER NAME" required> 
					<br>
					<input type="text" name="p3" maxlength="10" class="form-control" placeholder="CUSTOMER PHONE" required> 
					<br>
					<input type="TEXT" name="p4" maxlength="10" class="form-control" placeholder=" AMOUNT" required> 
					<br>
					<input type="TEXT" name="p5"  class="form-control" placeholder="ITEM PURCHASED" required> 
					<br>
					<input type="TEXT" name="p6"  class="form-control" placeholder="CUSTOMER ADDRESS" required> 
					<br>
