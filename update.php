...
{ ?>
                        ...
                        <td><input type="test" value="<?php echo $data['id']; ?>" readonly name="p1"> </td>						
                        <td><input type="test" value="<?php echo $data['name']; ?>" readonly name="p2"> </td>
						<td><input type="test" value="<?php echo $data['quantity']; ?>" readonly name="p3"> </td>
						<td><input type="test" value="<?php echo $data['price']; ?>" readonly name="p4"> </td>
						<td><input type="test" value="<?php echo $data['about']; ?>" readonly name="p5"> </td>
						
					
						
                     <td><button class="au-btn au-btn-icon au-btn--green au-btn--small" type="submit">UPDATE</button></td>
											</form>
                                            </tr>
